import { editAssertion, deleteAssertion,elements,field,otherElements } from './agencies_crudElements';
import { test, expect, Page } from '@playwright/test';
import { initAddContext, initEditContext } from './agencies_crudElements';
  ...
  await test.step('CRUD STEPS', async () => {
    ...
    switch (fieldLocator.type) {
      ...
      case 'combobox':
        ...
        try 
        {
          const firstOption = page2.getByRole('option').first();
